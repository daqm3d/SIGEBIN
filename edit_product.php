...
<?php
 if(isset($_POST['product'])){
    $req_fields = array('product-title','product-categorie','product-quantity','buying-price', 'saleing-price', 'models', 'bienes' );
   ...
   if(empty($errors)){
     ...
     /*  if (is_null($_POST['product-photo']) || $_POST['product-photo'] === "") {
       ...
       $query  .=" marca ='{$p_buy}', serial ='{$p_sale}', model ='{$p_model}', categorie_id ='{$p_cat}'";
