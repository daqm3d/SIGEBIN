  ...
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head pull-right">
           ...
           <strong class="text-right">Del departamento de  <?php  echo $departamentos ?></strong>
       </div>
    ...
    <div class="form-group" id="exportar">
      ...
      <form action="export_data_ex.php"><button type="submit"  name="submit" class="btn btn-primary">Exportar a EXCEL </button></form>
    </div>
  <?php
    else:
